...
function ProphecyPage() {
  ...
  function init() {
    ...
    // loader.parse(skull, generateSkull);
    // loader.parse(skull, (res) => {
    //   console.log(res);
    // });
    // loader.load(
    //   "https://raw.githubusercontent.com/ellenprobst/it-s-alive/master/blender/eyes.json",
    //   generateLeftEye
    // );
    // loader.load(
    //   "https://raw.githubusercontent.com/ellenprobst/it-s-alive/master/blender/eyes.json",
  ...
  function generateText() {
    ...
    loader.load(
      "https://raw.githubusercontent.com/ellenprobst/it-s-alive/master/scripts/optimer_regular.typeface.json",
      function (font) {
        var textGeometry = new TextGeometry("It's alive !", {
          font: font,
          size: 7.5,
          height: 3,
          curveSegments: 20,
        ...
        mesh.scale.z = mesh.scale.y = mesh.scale.x = 0.3;
        mesh.position.y = -10;
        mesh.position.x = -6;
        mesh.rotation.y = 0.3;
