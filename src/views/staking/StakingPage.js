...
const StakingPage = () => {
  useEffect(() => {
    // gsap.from("#bgl", { duration: 0.5, x: -500 });
    // gsap.from("#bgr", { duration: 0.5, x: 500 });
  });
    ...
    <main id="main">
          ...
          <div className="md:container md:mx-auto">
            {walletAddress != "" ? (
                    ...
                    {!isApproved ? (
                          ...
                          <div className=" border-purple-900 max-w-xl h-64 flex flex-col justify-between dark:bg-gray-800 rounded-lg border border-gray-400 mb-6 py-5 px-4">
                            <div className="text-center">
                              ...
                              <p className="text-white text-m">
                                ...
                                staking system access to your NFT. Use the
                      ...
                      <>
                        ...
                        >
                          ...
                          <p>
                            Every 1 minute you&apos;ll yield 10 $ORB for every
                            NFT you have staked.
                          </p>
                        </div>
              ...
              <div className="flex items-center justify-center ">
                <section className="text-center mx-6 mt-10 lg:w-2/3">
                  {/* <img
                    className="m-auto w-24 lg:w-48"
                    src="https://github.com/pharmawala/pharmawala.com/raw/main/logo.png"
                  /> */}
                  <h1 className="mt-10 text-black mb-1 text-2xl lg:text-3xl">
                    Stake Your NFT, and earn $ORB
                  </h1>
                  <div>
                    <p className="text-black text-xl mx-5 font-bold mt-3">
                      The $ORB token is a utility token in The NFT NAME
                      ecosystem, it does not represent any monetary value.
                    </p>
      ...
      <div className="absolute bottom-14 left-10 w-auto h-4 flex flex-row transition-all delay-1000 duration-700 opacity-100">
        <h3 className="font-800 cursor-default uppercase text-4xl uppercase font-black text-white">
          <span className="lg:ml-2 primary-font">Staking</span>
        </h3>
      </div>
    </main>
  );
